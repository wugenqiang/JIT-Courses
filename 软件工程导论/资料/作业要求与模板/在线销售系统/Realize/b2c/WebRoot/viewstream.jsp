...
<title><fmt:message key="viewstream.title" />
</title>
<content tag="heading">
<fmt:message key="viewstream.heading" />
</content>
...
<h2>
	Clickstream for
	<%=stream.getHostname()%></h2>

<b>Initial Referrer</b>
:
<a href="<%=stream.getInitialReferrer()%>"><%=stream.getInitialReferrer()%></a>
<br>
<b>Hostname</b>
:
<%=stream.getHostname()%><br>
<b>Session ID</b>
:
<%=request.getParameter("sid")%><br>
<b>Bot</b>
:
<%=stream.isBot() ? "Yes" : "No"%><br>
<b>Stream Start</b>
:
<%=stream.getStart()%><br>
<b>Last Request</b>
:
<%=stream.getLastRequest()%><br>
