...
<%@ page
	import="java.util.*,com.opensymphony.clickstream.Clickstream"%>
...
<title><fmt:message key="clickstreams.title" />
</title>
<content tag="heading">
<fmt:message key="clickstreams.heading" />
</content>
...
<p>
	...
	<%=count%>.
	<a href="viewstream.jsp?sid=<%=key%>"><b><%=(stream.getHostname() != null
											&& !stream.getHostname().equals("") ? stream
											.getHostname()
											: "Stream")%></b>
	</a> [<%=stream.getStream().size()%>
	reqs]
	<br />
