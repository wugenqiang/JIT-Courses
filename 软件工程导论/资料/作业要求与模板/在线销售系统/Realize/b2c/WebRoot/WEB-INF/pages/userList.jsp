...
<display:table name="userList" cellspacing="0" cellpadding="0"
	...
	<display:column property="username" escapeXml="true" sortable="true"
		titleKey="userForm.username" style="width: 25%"
	...
	<display:column property="email" sortable="true"
		titleKey="userForm.email" style="width: 25%" autolink="true"
		media="html" />
	<display:column property="email" titleKey="userForm.email"
		media="csv xml excel pdf" />
	<display:column sortProperty="enabled" sortable="true"
		titleKey="userForm.enabled" style="width: 16%; padding-left: 15px"
		media="html">
		<input type="checkbox" disabled="disabled"
			<c:if test="${users.enabled}">checked="checked"</c:if> />
	</display:column>
	<display:column property="enabled" titleKey="userForm.enabled"
		media="csv xml excel pdf" />
