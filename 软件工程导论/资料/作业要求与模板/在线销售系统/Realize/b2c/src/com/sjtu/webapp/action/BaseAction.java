...
import com.sjtu.util.ConvertUtil;
import com.sjtu.util.CurrencyConverter;
import com.sjtu.util.DateConverter;
...
public class BaseAction extends DispatchAction {
	...
	/**
	 * @see com.sjtu.util.ConvertUtil#convert(java.lang.Object)
	 */
	...
	/**
	 * @see com.sjtu.util.ConvertUtil#convertLists(java.lang.Object)
	 */
	...
	public User getUser(HttpServletRequest request) throws Exception {
		...
		if (user == null) {
			...
			if (auth != null) {
				String username = ((UserDetails) auth.getPrincipal())
						.getUsername();
